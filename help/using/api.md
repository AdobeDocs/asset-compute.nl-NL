...
| Naam | Type | Beschrijving | Voorbeeld |
|-------------------|----------|-------------|---------|
| `fmt` | `string` | De doelindeling van uitvoeringen kan ook `text` zijn voor tekstextractie en `xmp` voor het extraheren van XMP metagegevens als XML. Zie [ gesteunde formaten ](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/file-format-support) | `png` |
